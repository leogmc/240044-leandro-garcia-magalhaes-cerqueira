...
public class UsuarioController {
	...
	public ResponseEntity<?> listaUsuarios(@PathVariable Long id) {
		System.out.println("Buscando detalhes de Usuario e Comunidade");
		try {
			...
			System.out.println("Detalhes do usuario: " + usuarioDTO.toString() + "\n");
			System.out.println("Detalhes da comunidade: " + usuarioDTO.getComunidades() + "\n");
	...
	public String atribuiUsuarioNaComunidade(@PathVariable(name = "comunidadeId") Long comunidadeId) {
		...
		System.out.println("Membro associado na Comunidade." + "\n");
